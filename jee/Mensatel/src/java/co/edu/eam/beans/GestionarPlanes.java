...
public class GestionarPlanes implements Serializable {
    ...
    public void editar() {
        ...
        try {
            ...
            String json = "{\"idplan\":" + planSeleccionado + ",\"nombre\":\"" + nombrePlan + "\",\"numeromails\": " + numEmails + " ,\"numeromsjs\":" + numMensajes + ",\"numeropush\":" + numPush + ",\"numerosms\":" + numSms + ",\"valorplan\":" + valorPlan + "}";
            System.out.println(json);
            String resp = HTTPUtil.doPostEnviar(path, json);
            System.out.println(json);
            //  System.out.println(resp);
    ...
    public void buscar() {
        ...
        try {
            ...
            String json = "{\"idplan\":" + planSeleccionado + "}";
            System.out.println(json);
            String resp = HTTPUtil.doPostEnviar(path, json);
